                ...
                <div class="row">
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="form-group">
                            <label>Inicial</label>
                            <input type="number" min="0" class="form-control spinner-both"  id="inicial" name="inicial" value="<?php echo $titulos[0]->inicial; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="number" min="1" class="form-control spinner-both"  id="consecutivo" name="consecutivo" value="<?php echo $titulos[0]->consecutivo; ?>">
                        </div>
                    </div>
                </div>
            </fieldset><br/>
