...
/*		
	...
	function show_todos_categoria()
	{
		...
		$this->showMercanciaPorCategoria($paquete, $idCategoriaRed, $paisUsuario);
		
		$this->showMercanciaPorCategoria($membresia, $idCategoriaRed, $paisUsuario);
	}
